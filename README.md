<div align="center">
  ...
  <h3><b>Hello world" project as one app with Webpack</b></h3>
...
[Rails back end](https://github.com/Amazinggracee/hello-rails-back-end/tree/staging)
...
- link to the back-end: [Back-end] (https://github.com/Amazinggracee/hello-rails-back-end)
...
```sh
  git clone https://github.com/Amazinggracee/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/Amazinggracee/hello-react-front-end/issues. )
